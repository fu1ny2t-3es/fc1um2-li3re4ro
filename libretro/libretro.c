...
=======
>>>>>>> 41fa0e1b (Remove FCEUD_SoundToggle)
/*palette for FCEU*/
<<<<<<< HEAD
...
=======
         d   = (systemRegion >> 1) & 1;
         pal = systemRegion & 1;
>>>>>>> 7c0d82f4 (Rename dendy to 'isDendy')
         break;
      case 1: /* ntsc */
...
static void retro_run_blit_ps2(uint8 *gfx) {
	...
	unsigned height = 240;
	unsigned pitch  = 512;
>>>>>>> dfb0503 (Update ppu.c)
>>>>>>> da37082 (Update ppu.c)
