...
#include "../src/video.h"
<<<<<<< HEAD
>>>>>>> 2d111f87 (Update libretro_core_options.h)
=======
...
#define BLUE_EXPAND  3
#define BUILD_PIXEL(R, G, B) (((int)((R)&0x1f) << RED_SHIFT) | ((int)((G)&0x3f) << GREEN_SHIFT) | ((int)((B)&0x1f) << BLUE_SHIFT))
>>>>>>> 01e4410 (Update libretro_core_options.h)
#endif
...
=======
>>>>>>> 97babb60 (Remove FCEUD_SoundToggle)
/*palette for FCEU*/
<<<<<<< HEAD
...
=======
         d   = (systemRegion >> 1) & 1;
         pal = systemRegion & 1;
>>>>>>> 55444ff6 (Rename dendy to 'isDendy')
         break;
      case 1: /* ntsc */
...
static void retro_run_blit_ps2(uint8 *gfx) {
	...
	unsigned height = 240;
	unsigned pitch  = 512;
>>>>>>> 117ddfc (Update libretro_core_options.h)
>>>>>>> 3d11765 (Update libretro_core_options.h)
...
>>>>>>> bc9b316e (Update libretro_core_options.h)
=======
