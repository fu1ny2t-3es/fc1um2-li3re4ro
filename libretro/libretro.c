...
=======
         d   = (systemRegion >> 1) & 1;
         pal = systemRegion & 1;
>>>>>>> 66d0e042 (Rename dendy to 'isDendy')
         break;
      case 1: /* ntsc */
...
static void retro_run_blit_ps2(uint8 *gfx) {
	...
	unsigned height = 240;
	unsigned pitch  = 512;
>>>>>>> f4f2bfe (Update libretro.c)
>>>>>>> e463244 (Update libretro.c)
...
#endif
=======
>>>>>>> c1040fcb (Remove some DEBUG ifdefs)
      return false;
=======
	init_blit_buffer();
	if (!FCEUI_Initialize()) {
