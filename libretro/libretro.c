...
#define BLUE_EXPAND  3
#define BUILD_PIXEL(R, G, B) (((int)((R)&0x1f) << RED_SHIFT) | ((int)((G)&0x3f) << GREEN_SHIFT) | ((int)((B)&0x1f) << BLUE_SHIFT))
>>>>>>> 782204e (Update libretro_core_options.h)
#endif
...
=======
>>>>>>> 8662cb1a (Remove FCEUD_SoundToggle)
/*palette for FCEU*/
<<<<<<< HEAD
...
=======
         d   = (systemRegion >> 1) & 1;
         pal = systemRegion & 1;
>>>>>>> ea8d3225 (Rename dendy to 'isDendy')
         break;
      case 1: /* ntsc */
...
=======
=======
>>>>>>> 18ef2e4b (Update libretro_core_options.h)
	if (environ_cb(RETRO_ENVIRONMENT_GET_VARIABLE, &var) && var.value) {
...
static void retro_run_blit_ps2(uint8 *gfx) {
	...
	unsigned height = 240;
	unsigned pitch  = 512;
>>>>>>> 49cf0d6 (Update libretro_core_options.h)
>>>>>>> e56e6de (Update libretro_core_options.h)
...
>>>>>>> bb9e9002 (Update libretro_core_options.h)
=======
