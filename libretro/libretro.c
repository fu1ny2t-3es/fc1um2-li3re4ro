...
#include "../src/video.h"
<<<<<<< HEAD
>>>>>>> a6eb5d5e (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
=======
...
=======
>>>>>>> 7c34602f (Remove FCEUD_SoundToggle)
/*palette for FCEU*/
<<<<<<< HEAD
...
=======
         d   = (systemRegion >> 1) & 1;
         pal = systemRegion & 1;
>>>>>>> 7950a943 (Rename dendy to 'isDendy')
         break;
      case 1: /* ntsc */
...
static void retro_run_blit_ps2(uint8 *gfx) {
	...
	unsigned height = 240;
	unsigned pitch  = 512;
>>>>>>> fd2ff26 (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
>>>>>>> f5c246f (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
...
>>>>>>> 111119e1 (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
=======
