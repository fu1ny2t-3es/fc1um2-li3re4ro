...
#include "../src/video.h"
<<<<<<< HEAD
>>>>>>> bbb67ece (Update Makefile.libretro)
=======
...
#define BLUE_EXPAND  3
#define BUILD_PIXEL(R, G, B) (((int)((R)&0x1f) << RED_SHIFT) | ((int)((G)&0x3f) << GREEN_SHIFT) | ((int)((B)&0x1f) << BLUE_SHIFT))
>>>>>>> e5d7e47 (Update Makefile.libretro)
#endif
...
>>>>>>> 1e3645c (Update Makefile.libretro)
>>>>>>> e5d7e47 (Update Makefile.libretro)
#endif
#if defined(PSP) || defined(PS2)
...
=======
>>>>>>> 0ac6afa1 (Remove FCEUD_SoundToggle)
/*palette for FCEU*/
<<<<<<< HEAD
...
=======
         d   = (systemRegion >> 1) & 1;
         pal = systemRegion & 1;
>>>>>>> 0adb245e (Rename dendy to 'isDendy')
         break;
      case 1: /* ntsc */
...
static void retro_run_blit_ps2(uint8 *gfx) {
	...
	unsigned height = 240;
	unsigned pitch  = 512;
>>>>>>> 1379996 (Update Makefile.libretro)
>>>>>>> 1267dfe (Update Makefile.libretro)
...
>>>>>>> 1ab3ccd5 (Update Makefile.libretro)
=======
