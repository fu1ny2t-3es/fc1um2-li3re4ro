...
>>>>>>> b34fd70f (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
...
>>>>>>> 6d19ea9d (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
		uint32 tem;
		tem = PALRAM[0] | (PALRAM[0] << 8) | (PALRAM[0] << 16) | (PALRAM[0] << 24);
>>>>>>> 09aa6a76 (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
		tem |= 0x40404040;
