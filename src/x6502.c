...
<<<<<<< HEAD
	CPU_DB = ARead[A](A);
	return(CPU_DB);
>>>>>>> b4403cca (Update libretro_core_options.h)
=======
=======
static INLINE uint8 RdMem(uint32 A) {
>>>>>>> f23ff718 ((X6502) Further cleanups)
	return ((cpu.openbus = ARead[A](A)));
>>>>>>> 61089d97 (Update libretro_core_options.h)
}
...
<<<<<<< HEAD
>>>>>>> ad168006 (Update libretro_core_options.h)
=======
=======
=======
		cpu.PC++;
>>>>>>> 1172753 (Update libretro_core_options.h)
>>>>>>> ebb7f01 (Update libretro_core_options.h)
>>>>>>> 1a52b74a (Update libretro_core_options.h)
		switch (b1) {
