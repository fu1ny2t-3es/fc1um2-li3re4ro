...
X6502 cpu;
<<<<<<< HEAD
>>>>>>> 4825644 (Update Makefile.libretro)
...
<<<<<<< HEAD
	CPU_DB = ARead[A](A);
	return(CPU_DB);
>>>>>>> 2a28b99b (Update Makefile.libretro)
=======
=======
static INLINE uint8 RdMem(uint32 A) {
>>>>>>> e2320656 ((X6502) Further cleanups)
...
>>>>>>> 4825644 (Update Makefile.libretro)
		CPU_PC++;
>>>>>>> aabd541 (Backport macro changes to X6502.c)
<<<<<<< HEAD
>>>>>>> 8a09669 (Update Makefile.libretro)
<<<<<<< HEAD
>>>>>>> 47cc4f25 (Update Makefile.libretro)
=======
=======
=======
		cpu.PC++;
>>>>>>> f384d9c (Update Makefile.libretro)
>>>>>>> d756a20 (Update Makefile.libretro)
