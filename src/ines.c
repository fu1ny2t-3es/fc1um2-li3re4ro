...
iNES_HEADER head          = {0};
>>>>>>> d926ad2 (Update ppu.c)
=======
CartInfo iNESCart = { 0 };
>>>>>>> a390a70 (Update ppu.c)
...
>>>>>>> 0abbc0d (Update ppu.c)
>>>>>>> f7d7fda (Update ppu.c)
>>>>>>> 01794bc (Update ppu.c)
...
=======
   ...
   uint64 romSize          = 0;                 /* size of PRG + CHR rom */
>>>>>>> 9ed41395 (Remove some DEBUG ifdefs)
