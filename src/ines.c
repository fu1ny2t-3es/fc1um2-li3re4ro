...
#include "state.h"
#include "unif.h"
>>>>>>> aee58a21 (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
#include "vsuni.h"
...
iNES_HEADER head          = {0};
>>>>>>> e275319 (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
=======
CartInfo iNESCart = { 0 };
...
=======
	while (inpsel_nes10[x].input1 >= 0 || inpsel_nes10[x].input2 >= 0 || inpsel_nes10[x].inputfc >= 0) {
		...
		x++;
>>>>>>> 590699a (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
	}
}
...
>>>>>>> 6105edd (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
...
=======
    ...
    INES_BOARD( "1994 Super HiK 4-in-1",    128, Mapper128_Init         )
>>>>>>> 26dfeb8 (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
...
>>>>>>> 3f0485d (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
...
>>>>>>> ea0757a (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
...
>>>>>>> 7eefe77 (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
>>>>>>> 69df05f (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
>>>>>>> 590699a (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
...
=======
	...
	INES_BOARD( "Subor Karaoke",            514, Mapper514_Init         )
>>>>>>> 9743421 (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
	INES_BOARD( "Brilliant Com Cocoma Pack", 516, Mapper516_Init        )
<<<<<<< HEAD
>>>>>>> 590699a (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
>>>>>>> 7404ed4 (Change PLATFORM_SUPPORTS_ references to FRONTEND_SUPPORTS_)
...
=======
   ...
   uint64 romSize          = 0;                 /* size of PRG + CHR rom */
>>>>>>> b35026ea (Remove some DEBUG ifdefs)
