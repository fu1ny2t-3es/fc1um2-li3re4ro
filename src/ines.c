...
iNES_HEADER head          = {0};
>>>>>>> 87ac9ee (Update libretro.c)
=======
CartInfo iNESCart = { 0 };
>>>>>>> a028c74 (Update libretro.c)
...
=======
   ...
   uint64 romSize          = 0;                 /* size of PRG + CHR rom */
>>>>>>> fc57dd7c (Remove some DEBUG ifdefs)
