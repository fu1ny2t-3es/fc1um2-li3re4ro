...
iNES_HEADER head          = {0};
>>>>>>> 0275863 (Update libretro_core_options.h)
=======
CartInfo iNESCart = { 0 };
>>>>>>> a17556e (Update libretro_core_options.h)
...
=======
	while (inpsel_nes10[x].input1 >= 0 || inpsel_nes10[x].input2 >= 0 || inpsel_nes10[x].inputfc >= 0) {
		...
		x++;
>>>>>>> 52d45d2 (Update libretro_core_options.h)
	}
}
...
>>>>>>> a4c2fba (Update libretro_core_options.h)
...
=======
    ...
    INES_BOARD( "1994 Super HiK 4-in-1",    128, Mapper128_Init         )
>>>>>>> 446106b (Update libretro_core_options.h)
...
>>>>>>> 4481f5c (Update libretro_core_options.h)
...
>>>>>>> e0c496c (Update libretro_core_options.h)
...
>>>>>>> 3b54f57 (Update libretro_core_options.h)
>>>>>>> 52d45d2 (Update libretro_core_options.h)
...
>>>>>>> 28a244c (Update libretro_core_options.h)
...
=======
	...
	INES_BOARD( "Subor Karaoke",            514, Mapper514_Init         )
>>>>>>> 83d0f94 (Update libretro_core_options.h)
	INES_BOARD( "Brilliant Com Cocoma Pack", 516, Mapper516_Init        )
<<<<<<< HEAD
>>>>>>> 52d45d2 (Update libretro_core_options.h)
>>>>>>> cd26ce4 (Update libretro_core_options.h)
...
=======
   ...
   uint64 romSize          = 0;                 /* size of PRG + CHR rom */
>>>>>>> f980f24e (Remove some DEBUG ifdefs)
