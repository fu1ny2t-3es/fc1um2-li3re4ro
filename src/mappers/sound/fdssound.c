...
#include "../../sound.h"
#include "../../state.h"
>>>>>>> 49d2c4db (Update libretro.c):src/mappers/sound/fdssound.c
...
<<<<<<< HEAD
	return(X.DB);
>>>>>>> 1f5de247 (Update libretro.c)
=======
	return(cpu.DB);
>>>>>>> 0780a515 (Update libretro.c)
=======
	return(cpu.openbus);
>>>>>>> bac59be6 (Update libretro.c)
}
